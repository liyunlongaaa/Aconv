...
parser.add_argument("--model", type=str, default='Conv', help="the model used")
...
# Conv based model
if args.model == 'Conv':
    print('now eval a Conv based model')
...
if args.dataset == 'speechcommands':
    ...
    sd = torch.load('/home/yoos/Downloads/best_audio_model.pth', map_location=device)
