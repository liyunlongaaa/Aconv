...
def train(audio_model, train_loader, test_loader, args):
    ...
    if args.resume:
        ...
        audio_model.load_state_dict(torch.load("/kaggle/input/best-model/best_audio_model (1).pth", map_location='cpu'))
        audio_model = audio_model.to(device)
        optimizer.load_state_dict(torch.load("/kaggle/input/best-model/best_optim_state.pth", map_location='cpu'))
